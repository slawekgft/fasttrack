...
public class AllegroItemsControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        given(allegroOperationsService.findCategoriesIds(anyString())).willReturn(DEFAULT_CATEGORIES);
        given(allegroOperationsService.findItemsForCategoryAndKeyword(any(ItemRequest.class))).willReturn(Collections.emptySet());
    }
    ...
    public void shouldCheckItemRequestsExists() throws Exception {
        ...
        given(allegroOperationsService.getCategoriesNames(anySet())).willReturn(Arrays.asList("kat1", "kat2"));
